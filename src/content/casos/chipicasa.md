...
intro:
  es: "Chipicasa es una agencia inmobiliaria en Chipiona que necesitaba un sistema centralizado para gestionar propiedades, clientes y propietarios."
  en: "Chipicasa is a real estate agency in Chipiona that needed a centralized system to manage properties, clients and owners."
...
problem:
  ...
  en: "The agency needed a centralized system to manage properties, leads and owners, plus publish to external portals without duplicating work. Standard tools didn't cover their operations or offer a CRM adapted to their business."
...
result:
  ...
  en: "Chipicasa went from a basic website to an operational real estate CRM on WordPress. Now they manage their entire commercial flow —properties, clients and portal listings— from a single platform, reducing hours of manual work and increasing team professionalism."
...
quote:
  ...
  en:
    text: "Now we manage the entire agency from our website: properties, clients and listings on real estate portals. It's like having a custom CRM, but within WordPress."
    author: "Jeremy Scharberg, Manager at Chipicasa"
