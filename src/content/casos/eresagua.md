...
intro:
  es: "EresAgua es un proyecto de venta directa de un único producto distribuido en tres packs."
  en: "EresAgua is a direct sales project for a single product distributed in three packs."
...
problem:
  ...
  en: "The classic eCommerce model with catalog and cart didn't fit a single product. It was necessary to design a direct purchase experience, especially optimized for mobile, that would take the user from initial impact to payment in the fewest steps possible."
...
result:
  ...
  en: "From initial impact to checkout in just two clicks. Conversion increased, the mobile experience became extremely fast and the system was ready to scale without rebuilding the architecture."

quote:
  es:
    text: "Pasamos de una tienda convencional a una experiencia de compra directa. En móvil, comprar es cuestión de segundos."
    author: "Taras Piatyhora, Responsable de EresAgua"
  en:
    text: "We went from a conventional store to a direct purchase experience. On mobile, buying is a matter of seconds."
    author: "Taras Piatyhora, Manager at EresAgua"
