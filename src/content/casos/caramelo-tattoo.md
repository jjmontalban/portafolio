...
intro:
  es: "Caramelo Tattoo es un estudio de tatuajes que necesitaba una web con identidad visual potente y coherente con su estilo artístico."
  en: "Caramelo Tattoo is a tattoo studio that needed a website with a strong visual identity consistent with their artistic style."
...
problem:
  ...
  en: "The studio needed to stand out visually and offer a booking system that avoided appointment overlaps. Most visits came from Instagram, so the mobile experience had to be fast, direct and frictionless."
...
result:
  ...
  en: "The website faithfully reflects the studio's artistic identity and bookings are managed automatically without errors or overlaps. Clients book easily from mobile and the studio keeps their schedule always organized."

quote:
  es:
    text: "Queríamos una web con estilo propio y un sistema de reservas sencillo. Ahora nuestra agenda está siempre organizada y los clientes reservan sin complicaciones."
    author: "Señor Loba, Artista principal y propietario de Caramelo Tattoo"
  en:
    text: "We wanted a website with its own style and a simple booking system. Now our schedule is always organized and clients book without complications."
    author: "Señor Loba, Lead Artist and Owner of Caramelo Tattoo"
